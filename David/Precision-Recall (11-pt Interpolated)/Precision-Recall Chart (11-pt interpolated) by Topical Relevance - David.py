...
plt.title('Precision-Recall Chart (11-point Interpolated) by Topical Relevance – David', size=20)
plt.legend()

plt.grid(True)
plt.tight_layout()
plt.savefig("Precision-Recall Chart (11-pt Interpolated) by Topical Relevance - David.png")
plt.show()