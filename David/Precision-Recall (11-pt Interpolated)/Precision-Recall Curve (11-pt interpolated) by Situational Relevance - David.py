...
plt.title('Precision-Recall Curve (11-point Interpolated) by Situational Relevance – David', size=20)
plt.legend()

plt.grid(True)
plt.tight_layout()
plt.savefig("Precision-Recall Curve (11-pt Interpolated) by Situational Relevance - David.png")
plt.show()